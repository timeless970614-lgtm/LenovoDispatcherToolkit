  ...
  <div class="about-page">
    ...
    <div class="card hero-card">
      <div class="hero-content">
        ...
        <div class="hero-text">
          ...
          <div class="version-chip">v1.0.20</div>
        </div>
      </div>
    </div>
    ...
    <div class="grid-2">
      <div class="card">
        <div class="card-header">
          <span class="card-title">Build Information</span>
        </div>
        <div class="info-list">
          <div class="info-row">
            <span class="info-key">Version</span>
            <span class="info-val">1.0.20</span>
          </div>
          <div class="info-row">
          ...
          <div class="info-row">
            ...
            <span class="info-val">Vue 3 + Vite</span>
          </div>
          <div class="info-row">
            <span class="info-key">Backend</span>
            <span class="info-val">Go 1.23</span>
          </div>
          <div class="info-row">
    ...
    <div class="card">
      ...
      <p class="about-desc">
        ...
        energy performance preferences, and thermal modes â€” all through a modern, intuitive interface.
      </p>
      <div class="copyright">
        ...
        2023â€“2026 Lenovo Group LTD. All rights reserved.
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  data() {
    return {
      features: [
        'Real-time system information via WMI',
        'Dispatcher driver status monitoring',
        'Max processor frequency tuning',
        'DYTC thermal mode switching',
